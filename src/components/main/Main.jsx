...
const Main = ({ inProgressCount = 0, resolvedCount = 0 }) => {
  return (
    <div className="w-11/12 mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 py-8">
        <div
          className="relative card rounded-lg shadow-lg text-center text-white p-6 overflow-hidden"
          style={{
        ...
        >
          ...
          <img
            src={vector1}
            className="absolute right-0 top-0 h-full opacity-70 scale-x-[-1]"
          />
          <div className="relative card-body items-center justify-center">
